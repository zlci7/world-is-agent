...
Automatic reconnection requires Stardew Adapter 0.1.1 or the current RimWorld Adapter 0.1.0. The Runtime package does not include game adapters. Build and install them from [world-is-agent-adapters](https://github.com/zlci7/world-is-agent-adapters). See [Official Adapters](docs/development/guide.md#official-adapters).
...
Official adapters live in the independent [world-is-agent-adapters](https://github.com/zlci7/world-is-agent-adapters) Git repository. This repository contains the Runtime, Console, Protocol, and Runtime-owned Game Profiles.
